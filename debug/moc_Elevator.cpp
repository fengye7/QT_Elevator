...
QT_MOC_LITERAL(1, 9, 12), // "startElemove"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 9), // "Elevator*"
QT_MOC_LITERAL(4, 33, 3), // "ele"
QT_MOC_LITERAL(5, 37, 7) // "reached"

    },
    "Elevator\0startElemove\0\0Elevator*\0ele\0"
    "reached"
};
...
void Elevator::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->startElemove((*reinterpret_cast< Elevator*(*)>(_a[1]))); break;
        case 1: _t->reached((*reinterpret_cast< Elevator*(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (Elevator::*_t)(Elevator * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Elevator::startElemove)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (Elevator::*_t)(Elevator * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Elevator::reached)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void Elevator::startElemove(Elevator * _t1)
{
...
// SIGNAL 1
void Elevator::reached(Elevator * _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
